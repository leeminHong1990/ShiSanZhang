...
var GamePlayerInfoUI = UIBase.extend({
	...
	initUI:function() {
        ...
        this.posx_list = [[0.305,0.435,0.565,0.695],[0.4,0.6,0.1,0.9]];
        this.posy_list = [[0.82,0.82,0.82,0.82],[0.07,0.8,0.5,0.45]];
        this.anchor_list = [[0,1,0,1], [0,0.5,0.5,0.5]];
	},
            ...
            if(self.gameplayerinfo_panel.getName() == "prepareplayerinfo_panel"){
            	for(var i = 0 ; i < 4 ; i++ ){
            		if(i == idx - 10){
            		    ...
            		    if(h1global.player().curGameRoom.current_round > 0){
