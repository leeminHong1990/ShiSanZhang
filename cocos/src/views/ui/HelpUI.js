var HelpUI = UIBase.extend({
    ...
    initUI: function () {
        ...
        if(this.info_dict) {
            ...
            this.change_select("round_chx_" + ((this.info_dict["game_round"] !== undefined ? this.info_dict["game_round"] : this.info_dict["game_round"]) / 8 - 1).toString());
            var lucky_poker_num=0
            switch (this.info_dict["lucky_poker"]){
                case 0:
                    lucky_poker_num=0;
                    break;
                case 19:
            ...
            this.change_select("limit_chx_" + lucky_poker_num.toString());
