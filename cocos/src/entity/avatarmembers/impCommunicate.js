...
var impCommunicate = impBase.extend({
	...
	recvMsg : function(serverSitNum, mid, msg){
		...
		if (h1global.curUIMgr.gameroom_ui && h1global.curUIMgr.gameroom_ui.is_show) {
            h1global.curUIMgr.gameroom_ui.playMessageAnim(serverSitNum, mid, msg);
            if(mid >= 0 && mid <= 8) {
                if (info_dict["sex"] == 1) {
    ...
    recvExpression : function(fromIdx, toIdx, eid){
        ...
        if (h1global.curUIMgr.gameroom_ui && h1global.curUIMgr.gameroom_ui.is_show) {
            h1global.curUIMgr.gameroom_ui.playExpressionAnim(fromIdx, toIdx, eid);
        }
    },
	...
	recvAppVoice : function(serverSitNum, fileID, record_time){
        ...
        // 直接播放
        if(h1global.curUIMgr.gameroom_ui && h1global.curUIMgr.gameroom_ui.is_show) {
            h1global.curUIMgr.gameroom_ui.playVoiceAnim(serverSitNum, record_time / 1000);
        }
